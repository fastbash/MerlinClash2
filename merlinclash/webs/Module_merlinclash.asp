...
<head>
    ...
    <script>
        ...
        async function doRequest() {
            ...
            setTimeout('doRequest();', 500);//写入定时器
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (db_merlinclash["merlinclash_dnsedit_tag"]) {
                        $("input:radio[name='dnsedit_tag'][value=" + db_merlinclash["merlinclash_dnsedit_tag"] + "]").attr('checked', 'true');
                    }
                    if (db_merlinclash["merlinclash_linuxver"] >= 41) {
        ...
        function apply() {
            ...
            // var radio_dnsplan = document.getElementsByName("dnsplan").innerHTML = getradioval(1);
            var radio_dnsplan = document.getElementsByName("dnsplan").innerHTML = getradioval("dnsplan");
            var radio_dnsedit_tag = document.getElementsByName("dnsedit_tag").innerHTML = getradioval("dnsedit_tag");
            // var clashmodesel = document.getElementsByName("clashmode").innerHTML = getradioval(3);
            var clashmodesel = document.getElementsByName("clashmode").innerHTML = getradioval("clashmode");
            // var cusrulesel = document.getElementsByName("cusruleplan").innerHTML = getradioval(8);
            var cusrulesel = document.getElementsByName("cusruleplan").innerHTML = getradioval("cusruleplan");

            if (db_merlinclash["merlinclash_linuxver"] >= 41) {
                // var tproxymodesel = document.getElementsByName("tproxymode").innerHTML = getradioval(4);
                var tproxymodesel = document.getElementsByName("tproxymode").innerHTML = getradioval("tproxymode");
            }
            // var unplan = document.getElementsByName("unblockplan").innerHTML = getradioval(6);
            var unplan = document.getElementsByName("unblockplan").innerHTML = getradioval("unblockplan");
            // var dnshijacksel = document.getElementsByName("dnshijack").innerHTML = getradioval(7);
            var dnshijacksel = document.getElementsByName("dnshijack").innerHTML = getradioval("dnshijack");
            ...
            db_merlinclash["merlinclash_dnsplan"] = radio_dnsplan;
            db_merlinclash["merlinclash_dnsedit_tag"] = radio_dnsedit_tag;
        ...
        function update_clash() {
            var dbus_post = db_merlinclash;
            dbus_post["merlinclash_action"] = "20";
            push_data("clash_update.sh", "update", dbus_post);
        }
        function dnsplan() {
            var trig = ".show-btn4"
            $(trig).trigger("click");
                ...
                success: function (response) {
                    ...
                    if (init_count == 0) {
                        ...
                        if (arr[0] == "" || arr[1] == "") {
                            ...
                            $("#zash-board").html("<iframe id='zash-frame' style='width:100%;min-height:45rem;border:0;margin-top:1px;' src='" + zashHref + "'></iframe>");
                    ...
                    setTimeout("get_clash_status_front();", 1000);
                }
            });
        }
        //----------------详细状态-----------------------------
        ...
        function getradioval(sel_tmp) {
            if (sel_tmp == "dnsplan") {
                var radio_dnsplan = document.getElementsByName("dnsplan");
                for (i = 0; i < radio_dnsplan.length; i++) {
                    if (radio_dnsplan[i].checked) {
                        return radio_dnsplan[i].value
                    }
                }
            }
            if (sel_tmp == "dnsedit_tag") {
                var radio_dnsedit_tag = document.getElementsByName("dnsedit_tag");
                for (i = 0; i < radio_dnsedit_tag.length; i++) {
                    if (radio_dnsedit_tag[i].checked) {
                        return radio_dnsedit_tag[i].value
                    }
                }
            }
            if (sel_tmp == "yamlsel") {
        ...
        function load_cron_params() {
            ...
            var option_trit = [["2", "2分钟"], ["5", "5分钟"], ["10", "10分钟"], ["15", "15分钟"], ["20", "20分钟"], ["25", "25分钟"], 
            ["30", "30分钟"], ["1", "1小时"], ["3", "3小时"], ["6", "6小时"], ["12", "12小时"]];
        ...
        function regular_subscribe_save() {
            ...
            var subscribeplansel = document.getElementsByName("subscribeplan").innerHTML = getradioval("subscribeplan");
...
<body id="app" skin='<% nvram_get("sc_skin"); %>' onload="init();">
            ...
            <tr>
                <td height="100">
                    ...
                    <div id="log_content2" style="margin-left:15px;margin-right:15px;margin-top:10px;overflow:hidden">
                        <textarea cols="50" rows="30" wrap="off" readonly="readonly" id="log_content3"
                            autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                            style="border:1px solid #000;width:99%; font-family:'Lucida Console'; font-size:11px;background:transparent;color:#FFFFFF;
                            outline: none;padding-left:3px;padding-right:22px;overflow-x:hidden"></textarea>
                    </div>
                                    ...
                                    <tr>
                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                            ...
                                            <div class="SimpleNote" id="head_illustrate"><i></i>
                                                <p>Merlin Clash2</u></em></a>是一个基于<a
                                                        href='https://github.com/MetaCubeX/mihomo'
                                                        target='_blank'><em><u>Mihomo内核</u></em></a>的代理程序。
                                                </p>
                                            ...
                                            <div id="detail_status" class="content_status"
                                                ...
                                                <div style="margin-left:15px"><i>&nbsp;&nbsp;目前本功能支持Merlin
                                                        Clash相关进程状态和iptables表状态检测。</i></div>
                                                <div
                                                    ...
                                                    <textarea cols="63" rows="36" wrap="off" id="proc_status"
                                                        style="width:98%;padding-left:13px;padding-right:33px;border:0px solid #222;font-family:'Lucida Console'; 
                                                        font-size:11px;background: transparent;color:#FFFFFF;outline: none;overflow-x:hidden;"
                                            ...
                                            <div id="snifferrules_settings" class="contentMKP_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: -65px;display: none;">
                                                <div class="user_title">Sniffer域名嗅探黑白名单设置</div>
                                                <div style="margin-left:15px">
                                                    <i>1&nbsp;&nbsp;点击【保存文件】按钮，文本框内的内容会保存到/koolshare/merlinclash/yaml_basic/sniffer.yaml；</i>
                                                </div>
                                                <div style="margin-left:15px"><i>2&nbsp;&nbsp;更改配置内容后，需要重启Merlin
                                                        Clash才能生效；</i></div>
                                                <div style="margin-left:15px">
                                                    <i>3&nbsp;&nbsp;更多设置内容，请查阅https://docs.metacubex.one/function/dns/sniffer。</i>
                                                </div>
                                                <div id="snifferrules_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="63" rows="16" wrap="off" id="snifferrulestxt"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"
                                                        style="width: 940px; background: black; color: white; resize: none;"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node" class="button_gen" type="button"
                                                        onclick="savesniffer();" value="保存设置">
                                                    <input id="edit_node" class="button_gen" type="button"
                                                        onclick="close_sniffer();" value="返回主界面">
                                                </div>
                                            </div>
                                            <!-- this is the popup area for regular log -->
                                            <div id="regular_log_status" class="content_status"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: -20px;display: none;">
                                                <div class="user_title">【Merlin Clash】订阅定时更新日志</div>
                                                <div
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;overflow:hidden">
                                                    <textarea cols="63" rows="36" wrap="off" id="regular_log"
                                                        style="width:98%;padding-left:13px;padding-right:33px;border:0px solid #222;font-family:'Lucida Console'; 
                                                        font-size:11px;background: transparent;color:#FFFFFF;outline: none;overflow-x:hidden;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                ...
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input class="button_gen" type="button"
                                                        onclick="close_regular_log();" value="返回主界面">
                                                </div>
                                            </div>
                                            <div id="merlinclash_switch_show" style="margin:-1px 0px 0px 0px;">
                                                <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                    ...
                                                    class="FormTable" id="merlinclash_switch_table">
                                                    <thead>
                                                        <tr>
                                                            <td colspan="2">开关</td>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <div class="switch_field" style="float: left;">
                                                                <label for="merlinclash_enable">
                                                                    <input id="merlinclash_enable" class="switch"
                                                            ...
                                                            <div style="
                                                            /* display:table-cell;float: left;margin-left:70px;position: absolute; */
                                                            padding: 5.5px 0px;">
                                                                <a type="button" class="ks_btn" style="cursor:pointer"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <div id="merlinclash_version_show"
                                                                style="float: left;padding: 5.5px 7px 5.5px 0;">
                                                                <a class="hintstyle">
                                                                    <i>当前版本：</i>
                                                                </a>
                                                            </div>
                                                            <div id="update_button" style="padding: 5.5px 0px;">
                                                                <a id="updateBtn" type="button" class="ks_btn"
                                                                    style="cursor:pointer"
                                                                    onclick="update_clash()">检查并更新</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <div
                                                                style="display:table-cell;float: left;margin-left:0px; text-align: right;">
                                                    ...
                                                    <tr id="ip_state">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div>
                                                                <div style="display: flex;">
                                                                    <div style="width: 60%;
                                                                        white-space: nowrap; overflow: hidden; text-overflow: ellipsis; min-width: 0; margin-right: 5px; 
                                                                        ">
                                                                        <p><span class="ip-title">国内</span>:&nbsp;<span
                                                                                id="ip-ipipnet">Waiting....</span></p>
                                                                        <p><span class="ip-title">海外</span>:&nbsp;<span
                                                                                id="ip-ipapi">Waiting....</span>&nbsp;<span
                                                                                id="ip-ipapi-geo"></span></p>
                                                                    </div>
                                                                    <div style="width: 40%">

                                                                        <p><span
                                                                                class="ip-title">国内</span>&nbsp;:&nbsp;<span
                                                                                id="http-baidu">Waiting....</span></p>
                                                                        <p><span
                                                                                class="ip-title">海外</span>&nbsp;:&nbsp;<span
                                                                                id="http-google">Waiting....</span></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td cellpadding="0" cellspacing="0" style="padding:0" border="1"
                                                            ...
                                                            <input id="show_btn0" class="show-btn0"
                                                                style="cursor:pointer" type="button" value="首页功能" />
                                                            <input id="show_btn88" class="show-btn88"
                                                                style="cursor:pointer" type="button" value="切换线路" />
                                                            <input id="show_btn1" class="show-btn1"
                                                                style="cursor:pointer" type="button" value="配置文件" />
                                                            <input id="show_btn2" class="show-btn2"
                                                                style="cursor:pointer" type="button" value="自定规则" />
                                                            <input id="show_btn9" class="show-btn9"
                                                                style="cursor:pointer" type="button" value="访问控制" />
                                                            <input id="show_btn3" class="show-btn3"
                                                                style="cursor:pointer" type="button" value="高级模式" />
                                                            <input id="show_btn4" class="show-btn4"
                                                                style="cursor:pointer" type="button" value="附加功能" />
                                                            <input id="show_btn7" class="show-btn7"
                                                                style="cursor:pointer" type="button" value="日志记录" />
                                                            <input id="show_btn6" class="show-btn6"
                                                                style="cursor:pointer" type="button" value="当前配置" />
                                                            <input id="show_btn10" class="show-btn10"
                                                                style="cursor:pointer" type="button" value="DC用户" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div id="tablet_0" style="display: none;">
                                                <div id="merlinclash-content-overview">
                                                    <div id="merlinclash-yamls" style="margin:-1px 0px 0px 0px;">
                                                        <form name="form1">
                                                            <table style="margin:-1px 0px 0px 0px;" width="100%"
                                                                ...
                                                                <tr id="yamlselect">
                                                                    <th>配置文件选择</th>
                                                                    <td colspan="2">
                                                                        <select id="merlinclash_yamlsel" name="yamlsel"
                                                                            dataType="Notnull" msg="配置文件不能为空!"
                                                            ...
                                                            <tr id="dns_plan">
                                                                ...
                                                                <td colspan="2">
                                                                    <label for="merlinclash_clashmode">
                                                                        <input id="merlinclash_clashmode" type="radio"
                                                                            name="clashmode" value="default"
                                                                            checked="checked">使用配置文件设定
                                                                        <input id="merlinclash_clashmode" type="radio"
                                                                            name="clashmode" value="rule">规则模式
                                                                        <input id="merlinclash_clashmode" type="radio"
                                                                            name="clashmode" value="global">全局模式
                                                                        <input id="merlinclash_clashmode" type="radio"
                                                                            name="clashmode" value="direct">直连模式
                                                        ...
                                                        <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                            ...
                                                            <tr id="dns_plan">
                                                                <th><a class="hintstyle" href="javascript:void(0);"
                                                                        onclick="openmcHint(1)">DNS方案</a></th>
                                                                <td colspan="2">
                                                                    <label for="merlinclash_dnsplan">
                                                                        <input id="merlinclash_dnsplan" type="radio"
                                                                            name="dnsplan" value="rh"
                                                                            checked="checked">默认:Redir-Host&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input id="merlinclash_dnsplan" type="radio"
                                                                            name="dnsplan"
                                                                            value="fi">Fake-ip&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    </label>
                                                                    <p style="color:#FC0">&nbsp;</p>
                                                                    <p style="color:#FC0">
                                                                        1.默认为Redir-Host，兼容性良好，不正确的设置DNS可能被污染；</p>
                                                                    <p style="color:#FC0">
                                                                        2.Fake-ip，拒绝DNS污染。无法获得真实IP，部分游戏/P2P请求可能无法连接；</p>
                                                                    <p style="color:#FC0">3.Clash的DNS工作原理请查阅【<a
                                                                            href="https://wiki.metacubex.one/config/dns/diagram/#_3"
                                                                            target="_blank"><em><u>DNS解析流程</u></em></a>】；
                                                                    </p>
                                                                    <p style="color:#FC0">4.各模式DNS可通过附加功能的【<a
                                                                            style="cursor:pointer" onclick="dnsplan()"
                                                                            href="javascript:void(0);"><em><u>DNS编辑</em></u></a>】自行设置。
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr id="dns_fakeipblack">
                                                                <th><a class="hintstyle" href="javascript:void(0);"
                                                                        onclick="openmcHint(28)">黑名单设备解析服务器</a></th>
                                                                <td colspan="2">
                                                                    <div class="SimpleNote" id="head_illustrate">
                                                                        <input id="merlinclash_dns_fakeipblack"
                                                                            class="input_15_table" value="223.5.5.5">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr id="dns_hijack">
                                                                ...
                                                                <td colspan="2">
                                                                    <label for="merlinclash_dnshijack">
                                                                        <input id="merlinclash_dnshijack" type="radio"
                                                                            name="dnshijack" value="front"
                                                                            checked="checked">默认:劫持&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input id="merlinclash_dnshijack" type="radio"
                                                                            name="dnshijack" value="rear">不劫持
                                                                    </label>
                                                                    <p style="color:#FC0">
                                                                        默认：劫持局域网内所有DNS请求，防止因设备自定义DNS造成DNS污染</p>
                                                        ...
                                                        <tr id="clash_dashboard">
                                                            ...
                                                            <td>
                                                                <div
                                                                    style="display:table-cell;float: left;margin-left:0px;">
                                                                    <span
                                                                        id="dashboard_state2">管理面板</span>&nbsp;|&nbsp;<span
                                                                        id="dashboard_state4">面板密码</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="merlinclash-btn-container">
                                                                    <p style="margin-top: 8px"></p><a type="button" id="zash"></a></p>
                                                                    <p style="margin-top: 8px">只有在 Clash 正在运行的时候才可以访问
                                                                        Clash 管理面板</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr>
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(27)">重建服务</a></th>
                                                            <td colspan="2">
                                                                <div class="merlinclash-btn-container">
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        class="ks_btn" id="selectlist"
                                                                        onclick="selectlist_rebuild()">&nbsp;&nbsp;重建下拉列表&nbsp;&nbsp;</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(25)">强制关闭 Merlin Clash</a></th>
                                                            <td colspan="2">
                                                                <div class="merlinclash-btn-container">
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        class="ks_btn" id="hot_off"
                                                                        onclick="hot_off_mc()">&nbsp;&nbsp;热关闭&nbsp;&nbsp;</a>
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        class="ks_btn" id="cool_off"
                                                                        onclick="cool_off_mc()">&nbsp;&nbsp;冷关闭&nbsp;&nbsp;</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="clash_restart_job_tr">
                                                            ...
                                                            <td>
                                                                <select name="select_clash_restart"
                                                                    id="merlinclash_select_clash_restart"
                                                                    onChange="show_job()" class="input_option"
                                                                    style="margin:-1 0 0 10px;">
                                                                ...
                                                                <select name="select_clash_restart_day"
                                                                    id="merlinclash_select_clash_restart_day"
                                                                    class="input_option"></select>
                                                                <select name="select_clash_restart_week"
                                                                    id="merlinclash_select_clash_restart_week"
                                                                    class="input_option"></select>
                                                                <select name="select_clash_restart_hour"
                                                                    id="merlinclash_select_clash_restart_hour"
                                                                    class="input_option"></select>
                                                                <select name="select_clash_restart_minute"
                                                                    id="merlinclash_select_clash_restart_minute"
                                                                    class="input_option"></select>
                                                                <select name="select_clash_restart_minute_2"
                                                                    id="merlinclash_select_clash_restart_minute_2"
                                                                    class="input_option"></select>
                                                                <input type="button"
                                                                    id="merlinclash_select_clash_restart_save"
                                                                    class="ks_btn"
                                                                    style="vertical-align: middle; cursor:pointer;"
                                                                    onclick="clash_restart_save();" value="保存设置" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>二进制日志</th>
                                                            <td colspan="2">
                                                                <div class="merlinclash-btn-outputlog">
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        class="ks_btn" id="outputlog"
                                                                        onclick="outputlog()">&nbsp;&nbsp;导出日志&nbsp;&nbsp;</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <div id="tablet_88" style="display: none;">
                                                <div id="changenodelist">
                                                    <div id="zash-board"></div>
                                                </div>
                                                <div style="margin:10px 0 0 5px">
                                                    <div>
                                                        <i>
                                                            &nbsp;&nbsp;1.本页面集成zash面板显示；<br>
                                                            &nbsp;&nbsp;2.除了切换线路，其他不明白的设置请不要随意操作。<br>
                                                            &nbsp;&nbsp;3.如有问题卸载删除插件、清除浏览器缓存再次安装</i>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--配置文件-->
                                            <div id="tablet_1" style="display: none;">
                                                <div id="merlinclash-content-config" style="margin:-1px 0px 0px 0px;">
                                                    <table id="clashimport" style="
                                                        ...
                                                        <tr>
                                                            <th>手动上传Clash配置文件&nbsp;&nbsp;<a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openmcHint(10)"><em
                                                                        style="color: gold;">【上传必看】</em></a></th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                    <input type="file" id="clashconfig" size="50"
                                                                        name="file" />
                                                                    <span id="clashconfig_info"
                                                                        style="display:none;">完成</span>
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        id="clashconfig-btn-upload" class="ks_btn"
                                                                        onclick="upload_clashconfig()">上传配置文件</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">其他订阅转换Clash规则&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                        class="hintstyle" href="javascript:void(0);"
                                                                        onclick="openmcHint(6)"><em>【帮助】</em></td>
                                                            </tr>
                                                        </thead>
                                                        <tr id="subconverterlocal">
                                                            <th class="sp_bottom_line">
                                                                ...
                                                                <br>
                                                                <br><em
                                                                    style="color: gold;">SS&nbsp;|&nbsp;SSR&nbsp;|&nbsp;V2ray订阅|&nbsp;Trojan订阅</em>
                                                                <br>
                                                                <br>
                                                            </th>
                                                            <td class="sp_bottom_line">
                                                                <div class="SimpleNote"
                                                                    ...
                                                                    <textarea id="merlinclash_links3" warp="on"
                                                                        placeholder="&nbsp;&nbsp;&nbsp;请输入订阅连接（支持多个订阅地址，回车分行或用'|'隔开）"
                                                                        type="text"></textarea>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; width: 400px;">
                                                                    <span>emoji:</span>
                                                                    <input id="merlinclash_subconverter_emoji"
                                                                        type="checkbox" name="subconverter_emoji"
                                                                        checked="checked">
                                                                    <span>&nbsp;&nbsp;&nbsp;节点类型:</span>
                                                                    <input id="merlinclash_subconverter_append_type"
                                                                        type="checkbox" name="subconverter_append_type">
                                                                    <span>&nbsp;&nbsp;&nbsp;节点排序:</span>
                                                                    <input id="merlinclash_subconverter_sort"
                                                                        type="checkbox" name="subconverter_sort">
                                                                    <span>&nbsp;&nbsp;&nbsp;过滤非法节点:</span>
                                                                    <input id="merlinclash_subconverter_fdn"
                                                                        type="checkbox" name="subconverter_fdn">
                                                                    <br>
                                                                    <span>跳过证书验证:</span>
                                                                    <input id="merlinclash_subconverter_scv"
                                                                        type="checkbox" name="subconverter_scv">
                                                                    <span>&nbsp;&nbsp;&nbsp;启用udp:</span>
                                                                    <input id="merlinclash_subconverter_udp"
                                                                        type="checkbox" name="subconverter_udp"
                                                                        checked="checked">
                                                                    <span>&nbsp;&nbsp;&nbsp;启用xudp:</span>
                                                                    <input id="merlinclash_subconverter_xudp"
                                                                        type="checkbox" name="subconverter_xudp"
                                                                        checked="checked">
                                                                    <span>&nbsp;&nbsp;&nbsp;TCP Fast Open:</span>
                                                                    <input id="merlinclash_subconverter_tfo"
                                                                        type="checkbox" name="subconverter_tfo">
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; width: 400px;">
                                                                    <p><label>包含节点：</label>
                                                                        <input id="merlinclash_subconverter_include"
                                                                            class="input_25_table" style="width:320px"
                                                                            placeholder="&nbsp;筛选包含关键字的节点名，支持正则">
                                                                    </p>
                                                                    <br>
                                                                    <p><label>排除节点：</label>
                                                                        <input id="merlinclash_subconverter_exclude"
                                                                            class="input_25_table" style="width:320px"
                                                                            placeholder="&nbsp;过滤包含关键字的节点名，支持正则">
                                                                    </p>
                                                                    <br>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; width: 400px; height: 30px; line-height: 30px; ">
                                                                    <select id="merlinclash_clashtarget"
                                                                        style="width:100px;margin:0px 0px 0px 0px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <option value="clash">clash新参数</option>
                                                                        <option value="clashr">clashR新参数</option>
                                                                    </select>
                                                                    <select id="merlinclash_acl4ssrsel"
                                                                        style="width:195px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <option value="ZHANG">Merlin Clash_常规规则</option>
                                                                        <option value="ZHANG_NoAuto">Merlin Clash_常规无测速
                                                                        </option>
                                                                        <option value="ZHANG_Media">Merlin Clash_多媒体全量
                                                                        </option>
                                                                        <option value="ZHANG_Media_NoAuto">Merlin
                                                                            Clash_多媒体全量无测速</option>
                                                                        <option value="ZHANG_Media_Area_UrlTest">Merlin
                                                                            Clash_多媒体全量分地区测速</option>
                                                                        <option value="ZHANG_Media_Area_FallBack">Merlin
                                                                            Clash_多媒体全量分地区故障转移</option>
                                                                        <option value="ACL4SSR_Online">Online默认版_分组比较全
                                                                        </option>
                                                                        <option value="ACL4SSR_Online_AdblockPlus">
                                                                            AdblockPlus_更多去广告</option>
                                                                        <option value="ACL4SSR_Online_NoAuto">
                                                                            NoAuto_无自动测速</option>
                                                                        <option value="ACL4SSR_Online_NoReject">
                                                                            NoReject_无广告拦截规则</option>
                                                                        <option value="ACL4SSR_Online_Mini">Mini_精简版
                                                                        </option>
                                                                        <option value="ACL4SSR_Online_Mini_AdblockPlus">
                                                                            Mini_AdblockPlus_精简版更多去广告</option>
                                                                        <option value="ACL4SSR_Online_Mini_NoAuto">
                                                                            Mini_NoAuto_精简版无自动测速</option>
                                                                        <option value="ACL4SSR_Online_Mini_Fallback">
                                                                            Mini_Fallback_精简版带故障转移</option>
                                                                        <option value="ACL4SSR_Online_Mini_MultiMode">
                                                                            Mini_MultiMode_精简版自动测速故障转移负载均衡</option>
                                                                        <option value="ACL4SSR_Online_Full">
                                                                            Full全分组_重度用户使用</option>
                                                                        <option value="ACL4SSR_Online_Full_NoAuto">
                                                                            Full全分组_无自动测速</option>
                                                                        <option value="ACL4SSR_Online_Full_AdblockPlus">
                                                                            Full全分组_更多去广告</option>
                                                                        <option value="ACL4SSR_Online_Full_Netflix">
                                                                            Full全分组_奈飞全量</option>
                                                                        <option value="ACL4SSR_Online_Full_Google">
                                                                            Full全分组_谷歌细分</option>
                                                                        <option value="ACL4SSR_Online_Full_MultiMode">
                                                                            Full全分组_多模式</option>
                                                                        <option
                                                                            value="ACL4SSR_Online_Mini_MultiCountry">
                                                                            Full全分组_多国家地区</option>
                                                                    </select>
                                                                    <select id="merlinclash_acl4ssrsel_cus"
                                                                        style="width:195px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;display: none;"
                                                                        class="input_option">
                                                                    </select>
                                                                    <input id="merlinclash_customrule_cbox"
                                                                        type="checkbox"
                                                                        name="merlinclash_customrule_cbox"><span
                                                                        id="merlinclash_customrule_cbox_span">&nbsp;使用自定订阅</span>
                                                                    <script>
                                                                    ...
                                                                    <input id="merlinclash_cdn_cbox" type="checkbox"
                                                                        name="merlinclash_cdn_cbox"><span
                                                                        id="merlinclash_cdn_cbox_span">&nbsp;CDN订阅</span>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 30px; line-height: 30px; ">
                                                                    <label style="color: gold;">远程配置：</label>
                                                                    <input id="merlinclash_uploadiniurl"
                                                                        class="input_25_table" style="width:255px"
                                                                        placeholder="&nbsp;请输入文件URL地址">
                                                                    <input id="merlinclash_customurl_cbox"
                                                                        type="checkbox"
                                                                        name="merlinclash_customurl_cbox"><span>&nbsp;勾选使用</span>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 30px; line-height: 30px; ">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        id="merlinclash_uploadrename4" maxlength="20"
                                                                        class="input_25_table" style="width:255px"
                                                                        placeholder="&nbsp;重命名(支持20位数字/字母)">
                                                                    <a type="button"
                                                                        style="vertical-align: middle; margin:-10px 10px;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="get_online_yaml3(16)"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;开始转换&nbsp;&nbsp;</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="clashyamldown">
                                                            <th>
                                                                <br><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(14)">Clash订阅下载</a>
                                                                <br>
                                                                <br><em
                                                                    style="color: gold;">Clash专用订阅&nbsp;|&nbsp;ACL4SSR等转换订阅</em>
                                                            </th>
                                                            <td>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left;">
                                                                    <textarea id="merlinclash_links" warp="on"
                                                                        placeholder="&nbsp;&nbsp;&nbsp;请输入订阅连接（只支持单个订阅地址）"
                                                                        type="text"></textarea>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                    ...
                                                                    <input
                                                                        onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')"
                                                                        id="merlinclash_uploadrename" maxlength="20"
                                                                        class="input_25_table" style="width:255px"
                                                                        placeholder="&nbsp;重命名,支持20位数字/字母">
                                                                    <a type="button"
                                                                        style="vertical-align: middle; margin:-10px 10px;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="get_online_yaml(2)"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;Clash订阅&nbsp;&nbsp;</a>
                                                                </div>
                                                                <script>
                                                                    function updateInputValue() { 
                                                                        var content = document.getElementById('merlinclash_links').value; 
                                                                        var nameMatch = content.match(/name=([^\s&]+)/); 
                                                                        if (nameMatch) { 
                                                                            var nameValue = nameMatch[1]; 
                                                                            document.getElementById('merlinclash_uploadrename').value = nameValue; 
                                                                        } else { 
                                                                            var urlMatch = content.match(/https?:\/\/([^\/\s]+)/); 
                                                                            if (urlMatch) { var domain = urlMatch[1].split('.')[1]; 
                                                                                if (domain) { 
                                                                                    document.getElementById('merlinclash_uploadrename').value = domain; 
                                                                                }
                                                                            } 
                                                                        } 
                                                                    } 
                                                                    document.getElementById('merlinclash_links').addEventListener('input', updateInputValue); 
                                                                    document.getElementById('merlinclash_links').addEventListener('blur', updateInputValue);
                                                                </script>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <form name="form1">
                                                        ...
                                                        <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                            ...
                                                            <tr id="delyamlselect">
                                                                <th class="sp_bottom_line">更新订阅&nbsp;&nbsp;<span
                                                                        id="clash_yamlsel">当前配置为：</span></th>
                                                                <td class="sp_bottom_line" colspan="2">
                                                                    <div class="SimpleNote"
                                                                        style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                        <select id="merlinclash_delyamlsel"
                                                                            name="delyamlsel" dataType="Notnull"
                                                                            msg="配置文件不能为空!"
                                                                            class="input_option"></select>
                                                                        <a type="button" style="vertical-align: middle;"
                                                                            class="ks_btn" style="cursor:pointer"
                                                                            onclick="download_yaml_sel('downyaml')"
                                                                            href="javascript:void(0);">&nbsp;&nbsp;下载配置&nbsp;&nbsp;</a>
                                                                        <a type="button" style="vertical-align: middle;"
                                                                            class="ks_btn" style="cursor:pointer"
                                                                            onclick="del_yaml_sel(0)"
                                                                            href="javascript:void(0);">&nbsp;&nbsp;删除配置&nbsp;&nbsp;</a>
                                                                        <a type="button" style="vertical-align: middle;"
                                                                            class="ks_btn" style="cursor:pointer"
                                                                            onclick="update_yaml_sel(0)"
                                                                            href="javascript:void(0);">&nbsp;&nbsp;更新配置&nbsp;&nbsp;</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr id="clash_regular_job_tr">
                                                                ...
                                                                <td class="sp_bottom_line">
                                                                    <label for="merlinclash_subscribeplan">
                                                                        <input id="merlinclash_subscribeplan"
                                                                            type="radio" name="subscribeplan"
                                                                            value="all"
                                                                            checked="checked">更新全部配置&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input id="merlinclash_subscribeplan"
                                                                            type="radio" name="subscribeplan"
                                                                            value="used">更新当前配置&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    </label>
                                                                    <p></p>
                                                                    <select name="select_regular_subscribe"
                                                                        id="merlinclash_select_regular_subscribe"
                                                                        onChange="show_job()" class="input_option"
                                                                    ...
                                                                    <select name="select_regular_day"
                                                                        id="merlinclash_select_regular_day"
                                                                        class="input_option"></select>
                                                                    <select name="select_regular_week"
                                                                        id="merlinclash_select_regular_week"
                                                                        class="input_option"></select>
                                                                    <select name="select_regular_hour"
                                                                        id="merlinclash_select_regular_hour"
                                                                        class="input_option"></select>
                                                                    <select name="select_regular_minute"
                                                                        id="merlinclash_select_regular_minute"
                                                                        class="input_option"></select>
                                                                    <select name="select_regular_minute_2"
                                                                        id="merlinclash_select_regular_minute_2"
                                                                        class="input_option"></select>
                                                                    <a type="button" class="ks_btn"
                                                                        style="vertical-align: middle; cursor:pointer"
                                                                        onclick="regular_subscribe_save()"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;保存设置&nbsp;&nbsp;</a>
                                                                    <a type="button" class="ks_btn"
                                                                        style="vertical-align: middle; cursor:pointer"
                                                                        onclick="get_regular_log()"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;查看日志&nbsp;&nbsp;</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>
                                                                ...
                                                                <td>
                                                                    <div class="SimpleNote" id="head_illustrate">
                                                                        <input id="merlinclash_useragent"
                                                                            style="width:320px" class="input_15_table"
                                                                            placeholder="">
                                                                        <a type="button" class="ks_btn"
                                                                            style="vertical-align: middle; cursor:pointer"
                                                                            onclick="useragent_save()"
                                                                            href="javascript:void(0);">&nbsp;&nbsp;保存修改&nbsp;&nbsp;</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <div id="tablet_7" style="display: none;">
                                                <div id="merlinclash-notelog" style="margin:-1px 0px 0px 0px;">
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2"><em style="color: gold;">节点恢复日志/记录</em>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                    </table>
                                                    <div id="nodes_content" class="mc_outline" style="height: 160px;">
                                                        <textarea class="sbar" cols="63" rows="36" wrap="on"
                                                            readonly="readonly" id="nodes_content1"
                                                            style="margin: 0px; width: 709px; height: 150px; resize: none;"></textarea>
                                                    </div>
                                                </div>
                                                <div id="merlinclash-OPLOG" style="margin:5px 0px 0px 0px;">
                                                    <table style="margin:5px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable">
                                                        <thead>
                                                            <tr>
                                                    ...
                                                    <div id="log_content" class="mc_outline"
                                                        style="margin-top:-1px;overflow:hidden;">
                                                        <textarea class="sbar" cols="63" rows="36" wrap="on"
                                                            readonly="readonly" id="log_content1"
                                                            style="margin: 0px; width: 709px; height: 800px; resize: none;"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--自定规则-->
                                            <div id="tablet_2" style="display: none;">
                                                        ...
                                                        <tr id="cusrule_plan">
                                                            ...
                                                            <td colspan="2">
                                                                <label for="merlinclash_cusrule_plan">
                                                                    <input id="merlinclash_cusrule_plan" type="radio"
                                                                        name="cusruleplan" value="closed"
                                                                        checked="checked">关闭
                                                                    <input id="merlinclash_cusrule_plan" type="radio"
                                                                        name="cusruleplan" value="easy">开启
                                                ...
                                                <div id="merlinclash_cusrule_edit_content" class="mc_outline"
                                                    style="margin-top:-1px;overflow:hidden;">
                                                    <textarea rows="7" wrap="on" id="merlinclash_cusrule_edit_content1"
                                                        name="cusrule_edit_content1"
                                                        style="margin: 0px; width: 709px; height: 300px; resize: none;"></textarea>
                                                    <div style="text-align:center;vertical-align:middel;"><input
                                                            class="ks_btn" type="button" onclick="cusrulechange()"
                                                            value="修改提交"></div>
                                                </div>
                                                ...
                                                <div id="clash_ipsetproxy_area">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable"
                                                        id="merlinclash_ipset_table">
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">IPtables转发白名单 - 强制转发到Clash -- <em
                                                                        style="color: gold;">【编辑完成后点击“修改提交”保存，提交后生效】|【开启编辑：<input
                                                                            id="merlinclash_ipsetedit_check"
                                                                            class="barcodeSavePrint1" type="checkbox"
                                                                            name="ipsetedit_check">】</em></td>
                                                            </tr>
                                                            <script>
                                                                $(function () {
                                                    ...
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable"
                                                        id="merlinclash_ipsetproxy_content_table">
                                                        <tr id="ipsetproxy_edit_tr">
                                                            <th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
                                                            <td>
                                                                <input class="ks_btn" type="button"
                                                                    onclick="ipsetchange()" value="修改提交">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable">
                                                        <div id="merlinclash_ipsetproxy_edit_content"
                                                            style="margin-top:-1px;overflow:hidden;">
                                                            <textarea rows="7" wrap="on"
                                                                id="merlinclash_ipsetproxy_edit_content1"
                                                                name="ipsetproxy_edit_content1"
                                                                style="margin: 0px; width: 709px; height: 150px; resize: none;"
                                                ...
                                                <div id="clash_ipsetproxyarround_area">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable"
                                                        id="merlinclash_ipsetarround_table">
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">IPtables转发黑名单 - 强制绕行Clash -- <em
                                                                        style="color: gold;">【编辑完成后点击“修改提交”保存，提交后生效】|【开启编辑：<input
                                                                            id="merlinclash_ipsetarroundedit_check"
                                                                            class="barcodeSavePrint2" type="checkbox"
                                                                            name="ipsetarroundedit_check">】</em></td>
                                                            </tr>
                                                            <script>
                                                                $(function () {
                                                    ...
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable"
                                                        id="merlinclash_ipsetproxyarround_content_table">
                                                        <tr id="ipsetproxyarround_edit_tr">
                                                            <th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
                                                            <td>
                                                                <input class="ks_btn" type="button"
                                                                    onclick="ipsetarroundchange()" value="修改提交">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        align="center" cellpadding="4" cellspacing="0"
                                                        bordercolor="#6b8fa3" class="FormTable">
                                                        <div id="merlinclash_ipsetproxyarround_edit_content"
                                                            style="margin-top:-1px;overflow:hidden;">
                                                            <textarea rows="7" wrap="on"
                                                                id="merlinclash_ipsetproxyarround_edit_content1"
                                                                name="ipsetproxyarround_edit_content1"
                                                                style="margin: 0px; width: 709px; height: 150px; resize: none;"
                                                                readonly="true"></textarea>
                                                        </div>
                                                    </table>
                                                ...
                                                <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <a type="button"
                                                                style="vertical-align: middle; cursor:pointer;"
                                                                id="clashrestorerule-btn-download" class="ks_btn"
                                                                onclick="down_clashrestorerule(1)">导出自定义规则</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>恢复自定义规则</th>
                                                        <td colspan="2">
                                                            <div class="SimpleNote"
                                                                style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                <input type="file"
                                                                    style="width: 200px;margin: 0,0,0,0px;"
                                                                    id="clashrestorerule" size="50" name="file" />
                                                                <span id="clashrestorerule_info"
                                                                    style="display:none;">完成</span>
                                                                <a type="button"
                                                                    style="vertical-align: middle; cursor:pointer;"
                                                                    id="clashrestorerule-btn-upload" class="ks_btn"
                                                                    onclick="upload_clashrestorerule()">恢复自定义规则</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <div id="ACL_note" style="margin:10px 0 0 5px">
                                                    ...
                                                    <div>
                                                        <i>&nbsp;&nbsp;<em>2.已经支持自定义规则随配置文件自动切换，启用新配置无需删除之前自定义规则。</em></i>
                                                    </div>
                                                    <div><i>&nbsp;&nbsp;3.编辑新规则后，必须重启插件后才能生效；</i></div>
                                                    <div><i>&nbsp;&nbsp;4.更多说明请点击表头查看，或者参阅【<a
                                                                href="https://mcreadme.gitbook.io/mc/Advanced/Custom"
                                                                target="_blank"><em><u>Merlin
                                                                        Clash帮助文档</u></em></a>】。</i></div>
                                                    <div><i>&nbsp;</i></div>
                                                </div>
                                            </div>
                                            <!--访问控制-->
                                                ...
                                                <div id="nokpacllist">
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr id="wb_method_tr">
                                                            <th>访问控制匹配方法</th>
                                                            <td>
                                                                <select name="merlinclash_nokpacl_method"
                                                                    id="merlinclash_nokpacl_method" class="input_option"
                                                                    style="width:127px;margin:0px 0px 0px 2px;"
                                                ...
                                                <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <a type="button"
                                                                style="vertical-align: middle; cursor:pointer;"
                                                                id="passdevice-btn-download" class="ks_btn"
                                                                onclick="down_passdevice(1)">导出访问控制</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>恢复访问控制</th>
                                                        <td colspan="2">
                                                            <div class="SimpleNote"
                                                                ...
                                                                <input type="file"
                                                                    style="width: 200px;margin: 0,0,0,0px;"
                                                                    id="passdevice" size="50" name="file" />
                                                                <span id="passdevice_info"
                                                                    style="display:none;">完成</span>
                                                                <a type="button"
                                                                    style="vertical-align: middle; cursor:pointer;"
                                                                    id="passdevice-btn-upload" class="ks_btn"
                                                                    onclick="upload_passdevice()">恢复访问控制</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <div id="tablet_3" style="display: none;">
                                                ...
                                                <div id="merlinclash-patch" style="margin:-1px 0px 0px 0px;">
                                                    ...
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_watchdog">
                                                                        <input id="merlinclash_watchdog" class="switch"
                                                                            type="checkbox" style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                ...
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    ...
                                                                    <p style="color:gold; margin-top: 8px">
                                                                        注意：Clash本身运行稳定，通常不必开启该功能。</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="display:none;">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input id="merlinclash_watchdog_delay_time"
                                                                        maxlength="2" class="input_6_table"
                                                                        value="1"><span>&nbsp;分钟</span>
                                                                    <input type="button"
                                                                        id="merlinclash_clash_watchdog_save"
                                                                        class="ks_btn"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        onclick="clash_watchdog_save();" value="保存设置" />
                                                                    <script>
                                                ...
                                                <div id="noipt" style="margin:-1px 0px 0px 0px;">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">关闭透明代理 | <em
                                                                        style="color: gold">关闭后只能通过http/socks连接</em>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_closeproxy">
                                                                        <input id="merlinclash_closeproxy"
                                                                            type="checkbox" name="closeproxy"
                                                                            class="switch" style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                ...
                                                <div id="merlinclash-autodelay" style="margin:-1px 0px 0px 0px;">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr>
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(20)">开机自启推迟时间</a></th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input id="merlinclash_auto_delay_time"
                                                                        maxlength="3" class="input_6_table"
                                                                        value="120"><span>&nbsp;秒&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                    <input id="merlinclash_auto_delay_cbox"
                                                                        type="checkbox"
                                                                        name="merlinclash_auto_delay_cbox"><span>&nbsp;勾选后提交生效</span>
                                                                </div>
                                                                <script>
                                                        ...
                                                        <tr>
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(13)">检查日志重试次数</a></th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input id="merlinclash_check_delay_time"
                                                                        maxlength="3" class="input_6_table"
                                                                        value="40"><span>&nbsp;次&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尝试次数需大于20次</span>
                                                                    <input id="merlinclash_check_delay_cbox"
                                                                        type="hidden"
                                                                        name="merlinclash_check_delay_cbox"><!--<span>&nbsp;勾选后提交生效</span>-->
                                                                </div>
                                                                <script>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_startlog">
                                                                        <input id="merlinclash_startlog" type="checkbox"
                                                                            name="cir" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_queue_switch">
                                                                        <input id="merlinclash_queue_switch"
                                                                            type="checkbox" name="cir" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_recordbycron">
                                                                        <input id="merlinclash_recordbycron"
                                                                            type="checkbox" name="cir" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                        ...
                                                        <tr id="china_ip_route">
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(17)">大陆IP不经过Clash</a><span
                                                                    id="cirtag"></span></th>
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_cirswitch">
                                                                        <input id="merlinclash_cirswitch"
                                                                            type="checkbox" name="cir" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_dnsgoclash">
                                                                        <input id="merlinclash_dnsgoclash"
                                                                            type="checkbox" name="dnsgoclash"
                                                                            class="switch" style="display: none;"
                                                                            onchange="markdisplay('merlinclash_dnsgoclash')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                        ...
                                                        <tr id="mark_value">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_routingmark" maxlength="5"
                                                                        class="input_6_table" value="255">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_dnsclear">
                                                                        <input id="merlinclash_dnsclear" type="checkbox"
                                                                            name="dnsclear" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_mixport_enable">
                                                                        <input id="merlinclash_mixport_enable"
                                                                            type="checkbox" name="mixport"
                                                                            class="switch" style="display: none;">
                                                                        <div class="switch_container"
                                                                            onclick="mixport_save()"
                                                                            href="javascript:void(0);">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                    ...
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <!--预解析奈飞-->
                                                        <tr id="ena_sniffer">
                                                            <th>Sniffer域名嗅探 --<a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openmcHint(29)"><em
                                                                        style="color: gold;">【Netfilx
                                                                        TV客户端建议开启】</em></a></th>
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_sniffer">
                                                                        <input id="merlinclash_sniffer" type="checkbox"
                                                                            name="sniffer" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                ...
                                                                <input type="button"
                                                                    id="merlinclash_clash_routerrules_open"
                                                                    class="ks_btn"
                                                                    style="vertical-align: middle; cursor:pointer;"
                                                                    onclick="open_sniffer();" value="内容编辑" />
                                                            </td>
                                                        </tr>
                                                        <!--预解析检查间隔-->
                                                        <tr>
                                                            <th>TCP连接并发 --<a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openmcHint(30)"><em
                                                                        style="color: gold;">【说明】</em></a></th>
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_tcp_concurrent">
                                                                        <input id="merlinclash_tcp_concurrent"
                                                                            type="checkbox" name="tcp_concurrent"
                                                                            class="switch" style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">Merlin Clash&nbsp;&nbsp;自定义端口
                                                                    <input id="merlinclash_custom_cbox" type="checkbox"
                                                                        name="merlinclash_custom_cbox"><em
                                                                        style="color: gold;">勾选后提交生效</em>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_port" maxlength="5"
                                                                        class="input_6_table" value="3333">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_socksport" maxlength="5"
                                                                        class="input_6_table" value="23456">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_redirsport" maxlength="5"
                                                                        class="input_6_table" value="23457">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_tproxyport" maxlength="5"
                                                                        class="input_6_table" value="23458">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_dnslistenport" maxlength="5"
                                                                        class="input_6_table" value="23453">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="this.value=this.value.replace(/[^1-9]+/,'0')"
                                                                        id="merlinclash_cus_dashboardport" maxlength="5"
                                                                        class="input_6_table" value="9990">
                                                ...
                                                <div id="merlinclash-urltestTolerance" style="margin:-1px 0px 0px 0px;">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">自动测Ping值设置 <a class="hintstyle"
                                                                        href="javascript:void(0);"
                                                                        onclick="openmcHint(16)"><em
                                                                            style="color: gold;">【说明】</em></a></td>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            <th>自定义测速时间值(单位:秒)</th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <select id="merlinclash_intervalsel"
                                                                        style="width:60px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                    ...
                                                                    <input id="merlinclash_interval_cbox"
                                                                        type="checkbox"
                                                                        name="merlinclash_interval_cbox"><span>&nbsp;勾选后提交生效</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <select id="merlinclash_urltestTolerancesel"
                                                                        style="width:60px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                    ...
                                                                    <input id="merlinclash_urltestTolerance_cbox"
                                                                        type="checkbox"
                                                                        name="merlinclash_urltestTolerance_cbox"><span>&nbsp;勾选后提交生效</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <div id="merlinclash-dashboard" style="margin:-1px 0px 0px 0px;">
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">管理面板设定 -- <em
                                                                        style="color: gold;">【开启面板公网访问请设置复杂密码】</em></td>
                                                            </tr>
                                                        </thead>
                                                        <tr id="dashboard">
                                                            <th>开启管理面板公网访问</th>
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_dashboardswitch">
                                                                        <input id="merlinclash_dashboardswitch"
                                                                            type="checkbox" name="dashboard"
                                                                            class="switch" style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <input
                                                                        onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')"
                                                                        id="merlinclash_dashboard_secret"
                                                                        class="input_15_table" placeholder="">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr id="Tproxy_plan">
                                                            ...
                                                            <td colspan="2">
                                                                <label for="merlinclash_tproxymode">
                                                                    <input id="merlinclash_tproxymode" type="radio"
                                                                        name="tproxymode" value="closed"
                                                                        checked="checked">默认:关闭
                                                                    <input id="merlinclash_tproxymode" type="radio"
                                                                        name="tproxymode" value="tcp">仅开启TCP转发
                                                                    <input id="merlinclash_tproxymode" type="radio"
                                                                        name="tproxymode" value="udp">仅开启UDP转发
                                                                    <input id="merlinclash_tproxymode" type="radio"
                                                                        name="tproxymode" value="tcpudp">同时开启TCP&UDP
                                                                </label>
                                                                <p style="color:#FC0">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.默认为关闭</p>
                                                                <p style="color:#FC0">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.使用tproxy开启TCP转发实现透明代理
                                                                </p>
                                                                <p style="color:#FC0">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.使用tproxy开启UDP转发，类似【科学上网】的游戏模式
                                                                </p>
                                                                <p style="color:#FC0">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.使用tproxy开启TCP,UDP转发做透明代理
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr id="clash_ipv6" style="height: 30px;">
                                                            <th>IPv6代理 <a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(24)"><em style="color: gold;"> -
                                                                        不兼容护娃狂魔</em></a></th>
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_ipv6switch">
                                                                        <input id="merlinclash_ipv6switch"
                                                                            type="checkbox" name="ipv6" class="switch"
                                                                            style="display: none;">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                ...
                                                                <div style="line-height: 30px;">
                                                                    <p>需要运行在TPROXY-TCP或TPROXY-TCP&UDP模式下</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <div id="tablet_4" style="display: none;">
                                                <div id="merlinclash-content-additional"
                                                    ...
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr style="height: 30px;">
                                                            ...
                                                            <td colspan="2">
                                                                <div
                                                                    style="display:table-cell;float: left;text-align: center;text-align: center;line-height: 30px;">
                                                                    【自定规则】</div>
                                                                <div class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_check_aclrule">
                                                                        <input id="merlinclash_check_aclrule"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="aclrule_check"
                                                                            onchange="functioncheck('merlinclash_check_aclrule')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div
                                                                    style="display:table-cell;float: left;text-align: center;text-align: center;line-height: 30px;">
                                                                    【访问控制】</div>
                                                                <div id="merlinclash_check_control_switch"
                                                                    class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_check_controllist">
                                                                        <input id="merlinclash_check_controllist"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;"
                                                                            name="controllist_check"
                                                                            onchange="functioncheck('merlinclash_check_controllist')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div
                                                                    style="display: none !important;display:table-cell;float: left;text-align: center;text-align: center;line-height: 30px;">
                                                                    【DlerCloud登陆】</div>
                                                                <div class="switch_field"
                                                                    style="display: none !important;display:table-cell;float: left;">
                                                                    <label for="merlinclash_check_dlercloud">
                                                                        <input id="merlinclash_check_dlercloud"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;"
                                                                            name="dlercloud_check"
                                                                            onchange="functioncheck('merlinclash_check_dlercloud')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_clashimport">
                                                                        <input id="merlinclash_check_clashimport"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;"
                                                                            name="clashimport_check"
                                                                            onchange="functioncheck('merlinclash_check_clashimport')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_sclocal">
                                                                        <input id="merlinclash_check_sclocal"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="sclocal_check"
                                                                            onchange="functioncheck('merlinclash_check_sclocal')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_yamldown">
                                                                        <input id="merlinclash_check_yamldown"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="yamldown_check"
                                                                            onchange="functioncheck('merlinclash_check_yamldown')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_ipsetproxy">
                                                                        <input id="merlinclash_check_ipsetproxy"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;"
                                                                            name="ipsetproxy_check"
                                                                            onchange="functioncheck('merlinclash_check_ipsetproxy')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_ipsetproxyarround">
                                                                        <input id="merlinclash_check_ipsetproxyarround"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;"
                                                                            name="ipsetproxyarround_check"
                                                                            onchange="functioncheck('merlinclash_check_ipsetproxyarround')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_cdns">
                                                                        <input id="merlinclash_check_cdns"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="cdns_check"
                                                                            onchange="functioncheck('merlinclash_check_cdns')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_chost">
                                                                        <input id="merlinclash_check_chost"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="cdns_check"
                                                                            onchange="functioncheck('merlinclash_check_chost')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_noipt">
                                                                        <input id="merlinclash_check_noipt"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="noipt_check"
                                                                            onchange="functioncheck('merlinclash_check_noipt')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_cusport">
                                                                        <input id="merlinclash_check_cusport"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="cusport_check"
                                                                            onchange="functioncheck('merlinclash_check_cusport')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                                ...
                                                                <div id="tproxy_show"
                                                                    style="display:table-cell;float: left;text-align: center;text-align: center;line-height: 30px;">
                                                                    &nbsp;&nbsp;【TPROXY选项】</div>
                                                                <div id="tproxy_showcbox" class="switch_field"
                                                                    style="display:table-cell;float: left;">
                                                                    <label for="merlinclash_check_tproxy">
                                                                        <input id="merlinclash_check_tproxy"
                                                                            class="switch" type="checkbox"
                                                                            style="display: none;" name="tproxy_check"
                                                                            onchange="functioncheck('merlinclash_check_tproxy')">
                                                                        <div class="switch_container">
                                                                            <div class="switch_bar"></div>
                                                                            <div class="switch_circle transition_style">
                                                                                <div></div>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="switch_field"
                                                                    ...
                                                                    <label for="merlinclash_check_apply">
                                                                        <input class="button_gen" id="apply_button"
                                                                            type="button"
                                                                            onclick="functioncheck(false,true)"
                                                                            value="提交应用">
                                                                    </label>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">备份&还原 <a class="hintstyle"
                                                                        href="javascript:void(0);"
                                                                        onclick="openmcHint(22)"><em
                                                                            style="color:gold">【备份内容说明】</em></a></td>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            <th>一键备份</th>
                                                            <td colspan="2">
                                                                <a type="button"
                                                                    style="vertical-align: middle; cursor:pointer;"
                                                                    id="clashdata-btn-download" class="ks_btn"
                                                                    onclick="down_clashdata(1)">下载备份</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>一键还原</th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote"
                                                                    ...
                                                                    <input type="file"
                                                                        style="width: 200px;margin: 0,0,0,0px;"
                                                                        id="clashdata" size="50" name="file" />
                                                                    <span id="clashdata_info"
                                                                        style="display:none;">完成</span>
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        id="clashdata-btn-upload" class="ks_btn"
                                                                        onclick="upload_clashdata()">恢复备份</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr>
                                                            <th><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openmcHint(21)">GeoIP 数据库</a></th>
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <p>在线更新 Clash 使用的GeoIP数据库</p>
                                                                    <p style="color:#FC0">
                                                                        注：更新不会对比新旧版本号，重复点击会重复升级！（1个月左右更新一次即可）</p>
                                                                    <p>&nbsp;</p>
                                                                    <select id="merlinclash_geoip_type"
                                                                        style="width:120px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <!--<option value="maxmind">MaxMind-4M版</option>-->
                                                                        <option value="ipip">ipip-4M版</option>
                                                                        <option value="Hackl0us">Hackl0us-100kb版
                                                                        </option>
                                                                        <option value="Loyalsoldier">Loyalsoldier增强版
                                                                        </option>
                                                                        <option value="Loyalsoldier300">LoyalS-300kb版
                                                                        </option>
                                                                        <option value="Mcore_LCN">
                                                                            M核专用：Meta-GeositeCN-200K</option>
                                                                        <option value="Mcore_ALL">M核专用：Meta-Geosite-3M
                                                                        </option>
                                                                        <option value="Mcore_FULL">
                                                                            M核专用：Loyals—GeoSite-5M</option>
                                                                    </select>
                                                                    <a type="button" class="ks_btn"
                                                                        style="cursor:pointer"
                                                                        onclick="geoip_update(5)">更新GeoIP数据库</a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <p>大陆IP白名单 使用由Fernvenue提供的 <a
                                                                            href="https://github.com/fernvenue/chn-cidr-list"
                                                                            target="_blank"><u>CHN CIDR list</u></a>规则
                                                                    </p>
                                                                    <p style="color:#FC0">
                                                                        注：更新不会对比新旧版本号，重复点击会重复升级！（1个月左右更新一次即可）</p>
                                                                    <p>&nbsp;</p>
                                                                    <a type="button" class="ks_btn"
                                                                        style="cursor:pointer"
                                                                        onclick="chnroute_update(25)">更新大陆白名单规则</a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <p>
                                                                    <a style="color:#FC0" target="_blank"
                                                                        href="https://github.com/MetaCubeX/Clash.Meta/releases">【<u>Mihomo</u>】</a>
                                                                    <a style="color:#FC0" target="_blank"
                                                                        href="https://github.com/MetaCubeX/subconverter/releases">【<u>Subconverter-vless</u>】</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                    <select id="merlinclash_binary_type"
                                                                        style="width:80px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <option value="clash">Mihomo</option>
                                                                        <option id="subc_show" value="subconverter">
                                                                            Subconverter</option>
                                                                    </select>
                                                                    <input type="file" id="clashbinary" size="50"
                                                                        name="file" />
                                                                    <span id="clashbinary_upload"
                                                                        style="display:none;">完成</span>
                                                                    <a type="button"
                                                                        style="vertical-align: middle; cursor:pointer;"
                                                                        id="clashbinary-btn-upload" class="ks_btn"
                                                                        onclick="upload_clashbinary()">上传二进制</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="up_scrule">
                                                            ...
                                                            <td colspan="2">
                                                                <div class="SimpleNote" id="head_illustrate">
                                                                    <a type="button" id="updatescBtn" class="ks_btn"
                                                                        style="cursor:pointer"
                                                                        onclick="sc_update(18)">&nbsp;&nbsp;更新规则&nbsp;&nbsp;</a>
                                                    ...
                                                    <div id="clash_dns_area">
                                                        <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                            align="center" cellpadding="4" cellspacing="0"
                                                            bordercolor="#6b8fa3" class="FormTable"
                                                            id="merlinclash_dnsfiles_table">
                                                            <thead>
                                                                <tr>
                                                                    <td colspan="2">DNS&nbsp;&nbsp;编辑 -- <em
                                                                            style="color: gold;">【不懂勿动！编辑完成后点击“修改提交”保存，下次启动后生效】|【开启编辑：<input
                                                                                id="merlinclash_dnsedit_check"
                                                                                class="barcodeSavePrint" type="checkbox"
                                                                                name="dnsedit_check">】</em></td>
                                                                </tr>
                                                                <script>
                                                                    $(function () {
                                                        ...
                                                        <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                            align="center" cellpadding="4" cellspacing="0"
                                                            bordercolor="#6b8fa3" class="FormTable"
                                                            id="merlinclash_dnsfiles_content_table">
                                                            <tr id="dns_plan_edit">
                                                                <th>DNS内容编辑</th>
                                                                <td colspan="2">
                                                                    <label for="merlinclash_dnsedit_tag">
                                                                        <input id="merlinclash_dnsedit_tag" type="radio"
                                                                            name="dnsedit_tag" value="redirhost"
                                                                            checked="checked">Redir-Host
                                                                        <input id="merlinclash_dnsedit_tag" type="radio"
                                                                            name="dnsedit_tag" value="fakeip">Fake-ip
                                                                        <!-- <input id="merlinclash_dnsedit_tag" type="radio" name="dnsedit_tag" value="rhbypass">RHbypass -->
                                                                        <input class="ks_btn" type="button"
                                                                            onclick="dnsfilechange()" value="修改提交">
                                                                    </label>
                                                                    <script>
                                                                        $("[name='dnsedit_tag']").on("change",
                                                                            function (e) {
                                                        ...
                                                        <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                            align="center" cellpadding="4" cellspacing="0"
                                                            bordercolor="#6b8fa3" class="FormTable">
                                                            <div id="merlinclash_dns_edit_content" class="mc_outline"
                                                                style="margin-top:-1px;overflow:hidden;">
                                                                <textarea rows="7" wrap="on"
                                                                    id="merlinclash_dns_edit_content1"
                                                                    name="dns_edit_content1"
                                                                    style="margin: 0px; width: 709px; height: 300px; resize: none;"
                                                                    readonly="true"></textarea>
                                                            </div>
                                                        </table>
                                                    </div>
                                                    <div id="clash_host_area">
                                                        ...
                                                        <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <td colspan="2">自定义Hosts<a class="hintstyle"
                                                                            href="javascript:void(0);"
                                                                            onclick="openmcHint(11)"><em>【说明】</a></em>&nbsp;<em
                                                                            style="color:gold;">【不懂勿动！编辑完成后点击“修改提交”保存，下次启动后生效】|【开启编辑：<input
                                                                                id="merlinclash_hostedit_check"
                                                                                class="hostenableedit" type="checkbox"
                                                                                name="hostedit_check">】</em></td>
                                                                </tr>
                                                            </thead>
                                                            <script>
                                                                $(function () {
                                                            ...
                                                            <tr id="hostselect">
                                                                <th>HOST文件选择</th>
                                                                <td colspan="2">
                                                                    <select id="merlinclash_hostsel" name="hostsel"
                                                                        dataType="Notnull" msg="HOST文件不能为空!"
                                                                        class="input_option"></select>
                                                                    <a type="button" style="vertical-align: middle;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="hostchange()"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;修改提交&nbsp;&nbsp;</a>
                                                                    <a type="button" style="vertical-align: middle;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="download_host()"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;下载HOST&nbsp;&nbsp;</a>
                                                                    <a type="button" style="vertical-align: middle;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="del_host_sel()"
                                                                        href="javascript:void(0);">&nbsp;&nbsp;删除HOST&nbsp;&nbsp;</a>
                                                                </td>
                                                                <script>
                                                        ...
                                                        <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                            align="center" cellpadding="4" cellspacing="0"
                                                            bordercolor="#6b8fa3" class="FormTable">
                                                            <div id="merlinclash_host_content" class="mc_outline"
                                                                style="margin-top:-1px;overflow:hidden;">
                                                                <textarea rows="7" wrap="on"
                                                                    id="merlinclash_host_content1"
                                                                    style="margin: 0px; width: 709px; height: 300px; resize: none; "
                                                                    readonly="true"></textarea>
                                                            </div>
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <div class="SimpleNote"
                                                                        style="display:table-cell;float: left; height: 110px; line-height: 110px; margin:-40px 0;">
                                                                        <input type="file" id="clashhost" size="50"
                                                                            name="file" />
                                                                        <span id="clashhost_upload"
                                                                            style="display:none;">完成</span>
                                                                        <a type="button"
                                                                            style="vertical-align: middle; cursor:pointer;"
                                                                            id="clashhost-btn-upload" class="ks_btn"
                                                                            onclick="upload_clashhost()">上传HOST文件</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <div id="tablet_6" style="display: none;">
                                                <div id="yaml_content" class="mc_outline" style="height: 650px;">
                                                    <textarea class="sbar" cols="63" rows="36" wrap="on"
                                                        readonly="readonly" id="yaml_content1"
                                                        style="margin: 0px; width: 709px; height: 645px; resize: none;"></textarea>
                                                </div>
                                            </div>
                                            <!--dlercloud-->
                                            <div id="tablet_10" style="display: none;">
                                                    ...
                                                    <table style="margin:-1px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <tr id="clash_loginname">
                                                            ...
                                                            <td>
                                                                <div
                                                                    style="display:table-cell;float: left;margin-left:0px;">
                                                                    <input id="merlinclash_dc_name"
                                                                        style="color: #FFFFFF; width: 300px; height: 20px; 
                                                                        background-color:rgba(87,109,115,0.5); font-family: Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px;"
                                                                        placeholder="">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="clash_loginpasswd">
                                                            ...
                                                            <td>
                                                                <div
                                                                    style="display:table-cell;float: left;margin-left:0px;">
                                                                    <input id="merlinclash_dc_passwd" type="password"
                                                                        style="color: #FFFFFF; width: 300px; height: 20px; background-color:rgba(87,109,115,0.5); font-family: Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px;"
                                                                        placeholder="">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <a type="button"
                                                                        style="vertical-align: middle; margin:-10px 10px;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        href="https://dlercloud.com/auth/login"
                                                                        target="_blank">&nbsp;&nbsp;官网&nbsp;&nbsp;</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div id="dlercloud_content" style="width:750px; height: 650px;">
                                                    ...
                                                    <table style="margin:10px 0px 0px 0px;" width="100%" border="1"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2">订阅相关 -- <em
                                                                        style="color: gold;">如重置过连接参数，需要退出重新登陆才可以订阅</em>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                        <tr id="clash_ss">
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <a type="button"
                                                                        style="vertical-align: middle; margin:-10px 10px;"
                                                                        class="ks_btn" style="cursor:pointer"
                                                                        onclick="dc_ss_yaml(2)"
                                                                        href="javascript:void(0);">订阅</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="clash_v2">
                                                        ...
                                                        <tr id="sc3in1">
                                                            <th><br>SubConverter三合一转换
                                                                ...
                                                                <br><em
                                                                    style="color: gold;">SS&nbsp;|&nbsp;SSR&nbsp;|&nbsp;V2ray订阅|&nbsp;Trojan订阅</em>
                                                                <br><em
                                                                    style="color: gold;">内置ACL4SSR/MerlinClash专属规则</em>
                                                            ...
                                                            <td>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; width: 400px;">
                                                                    <span>emoji:</span>
                                                                    <input id="merlinclash_dc_subconverter_emoji"
                                                                        type="checkbox" name="dc_subconverter_emoji"
                                                                        checked="checked">
                                                                    <span>启用udp:</span>
                                                                    <span id="merlinclash_dc_subconverter_udp"
                                                                        type="checkbox" name="dc_subconverter_udp">
                                                                        <label>节点类型:</span>
                                                                    <span id="merlinclash_dc_subconverter_append_type"
                                                                        type="checkbox"
                                                                        name="dc_subconverter_append_type">
                                                                        <label>节点排序:</span>
                                                                    <span id="merlinclash_dc_subconverter_sort"
                                                                        type="checkbox" name="dc_subconverter_sort">
                                                                        <label>过滤非法节点:</span>
                                                                    <span id="merlinclash_dc_subconverter_fdn"
                                                                        type="checkbox" name="dc_subconverter_fdn">
                                                                        <br>
                                                                        <span>跳过证书验证:</span>
                                                                        <input id="merlinclash_dc_subconverter_scv"
                                                                            type="checkbox" name="dc_subconverter_scv">
                                                                        <span>TCP Fast Open:</span>
                                                                        <input id="merlinclash_dc_subconverter_tfo"
                                                                            type="checkbox" name="dc_subconverter_tfo">
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; width: 400px;">
                                                                    <p><span>包含节点：</span>
                                                                        <input id="merlinclash_dc_subconverter_include"
                                                                            class="input_25_table" style="width:320px"
                                                                            placeholder="&nbsp;筛选包含关键字的节点名，支持正则">
                                                                    </p>
                                                                    <br>
                                                                    <p><span>排除节点：</span>
                                                                        <input id="merlinclash_dc_subconverter_exclude"
                                                                            class="input_25_table" style="width:320px"
                                                                            placeholder="&nbsp;过滤包含关键字的节点名，支持正则">
                                                                    </p>
                                                                </div>
                                                                <div class="SimpleNote"
                                                                    style="display:table-cell;float: left; height: 30px; line-height: 30px; ">
                                                                    <select id="merlinclash_dc_clashtarget"
                                                                        style="width:75px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <option value="clash">clash新参数</option>
                                                                        <option value="clashr">clashR新参数</option>
                                                                    </select>
                                                                    <select id="merlinclash_dc_acl4ssrsel"
                                                                        style="width:220px;margin:0px 0px 0px 2px;text-align:left;padding-left: 0px;"
                                                                        class="input_option">
                                                                        <option value="ZHANG">Merlin Clash_常规规则</option>
                                                                        <option value="ZHANG_NoAuto">Merlin Clash_常规无测速
                                                                        </option>
                                                    ...
                                                    <div class="SimpleNote"
                                                        style="margin-left:270px ; display:table-cell;float: left; height: 30px; line-height: 30px; ">
                                                        <label style="color: gold;">远程配置：</label>
                                                        <input id="merlinclash_dc_uploadiniurl" class="input_25_table"
                                                            style="width:185px" placeholder="&nbsp;请输入文件URL地址">
                                                        <input id="merlinclash_dc_customurl_cbox" type="checkbox"
                                                            name="merlinclash_dc_customurl_cbox"><span>&nbsp;勾选使用</span>
                                                        <a type="button"
                                                            style="vertical-align: middle; margin:-10px 10px;"
                                                            class="ks_btn" style="cursor:pointer"
                                                            onclick="get_online_yaml4(21)"
                                                            href="javascript:void(0);">&nbsp;&nbsp;开始转换&nbsp;&nbsp;</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="apply_gen">
                                                <input class="button_gen" id="delallowneracls_button" type="button"
                                                    onclick="delallaclconfigs()" value="全部删除">
                                                <input class="button_gen" id="apply_button" type="button"
                                                    onclick="apply()" value="保存&启动">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
    ...
    <div id="loadingMask"
        style="display:none; 
        position: fixed; top: 0; left: 0; width: 100%; height: 100%; backdrop-filter: blur(1px); -webkit-backdrop-filter: blur(1px); background: rgba(0,0,0,0.3); z-index: 9999;
        /* display: none; position: fixed; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0); z-index: 9999; */
        ">
        <p style="
        position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 1.5em;
        /* position: absolute; top: 2%; right: 0%; transform: translate(-50%, -50%); color: white; */
        ">加载中...</p>
    </div>
</body>
